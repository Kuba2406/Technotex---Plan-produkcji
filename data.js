...
// ---- Typy krosien (9 loom types) ----
const TYPY_KROSIEN = [
  { id: 1, nazwa: 'PICANOL GTM-A',  kolor: '#2980b9', skrot: 'PGA' },
  { id: 2, nazwa: 'PICANOL GTM-B',  kolor: '#27ae60', skrot: 'PGB' },
  { id: 3, nazwa: 'PICANOL OMNI',   kolor: '#d4a017', skrot: 'OMN' },
  { id: 4, nazwa: 'DORNIER',        kolor: '#8e44ad', skrot: 'DOR' },
  { id: 5, nazwa: 'SULZER P7200',   kolor: '#16a085', skrot: 'SUL' },
  { id: 6, nazwa: 'TOYOTA JAT',     kolor: '#2c3e50', skrot: 'TOY' },
  { id: 7, nazwa: 'VAMATEX',        kolor: '#c0392b', skrot: 'VAM' },
  { id: 8, nazwa: 'SOMET',          kolor: '#d35400', skrot: 'SOM' },
  { id: 9, nazwa: 'LINDAUER',       kolor: '#5d4037', skrot: 'LIN' },
];

// ---- Initial articles (9 artykuły) ----
const ARTYKULY_INIT = [
  { id: 1, nazwa: 'BT 367',     watkiNaCm: 18, rozpinka: 160, rodzeSnucia: 'bezpośrednie' },
  { id: 2, nazwa: 'BT 773/150', watkiNaCm: 22, rozpinka: 150, rodzeSnucia: 'bezpośrednie' },
  { id: 3, nazwa: 'BTR 130',    watkiNaCm: 42, rozpinka: 175, rodzeSnucia: 'klejone' },
  { id: 4, nazwa: 'AT 210',     watkiNaCm: 28, rozpinka: 200, rodzeSnucia: 'bezpośrednie' },
  { id: 5, nazwa: 'AT 155',     watkiNaCm: 35, rozpinka: 155, rodzeSnucia: 'klejone' },
  { id: 6, nazwa: 'BT 500',     watkiNaCm: 20, rozpinka: 220, rodzeSnucia: 'bezpośrednie' },
  { id: 7, nazwa: 'BT 220',     watkiNaCm: 24, rozpinka: 130, rodzeSnucia: 'bezpośrednie' },
  { id: 8, nazwa: 'BTR 200',    watkiNaCm: 38, rozpinka: 190, rodzeSnucia: 'klejone' },
  { id: 9, nazwa: 'AT 300',     watkiNaCm: 30, rozpinka: 180, rodzeSnucia: 'bezpośrednie' },
];
...
// ---- Production orders ----
const ZLECENIA_INIT = [
  { id: 1, numer: 'ZL-001/2026', artId: 1, iloscM: 5000, status: 'w_trakcie', dataUtworzenia: '2026-06-01', terminRealizacji: '2026-07-31' },
  { id: 2, numer: 'ZL-002/2026', artId: 3, iloscM: 3000, status: 'w_trakcie', dataUtworzenia: '2026-06-15', terminRealizacji: '2026-08-15' },
  { id: 3, numer: 'ZL-003/2026', artId: 5, iloscM: 2000, status: 'zrealizowane', dataUtworzenia: '2026-05-01', terminRealizacji: '2026-06-30' },
  { id: 4, numer: 'ZL-004/2026', artId: 2, iloscM: 4000, status: 'nowe',      dataUtworzenia: '2026-07-01', terminRealizacji: '2026-09-01' },
  { id: 5, numer: 'ZL-005/2026', artId: 7, iloscM: 1500, status: 'w_trakcie', dataUtworzenia: '2026-06-20', terminRealizacji: '2026-07-25' },
  { id: 6, numer: 'ZL-006/2026', artId: 4, iloscM: 6000, status: 'nowe',      dataUtworzenia: '2026-07-05', terminRealizacji: '2026-10-01' },
];
...
const state = {
  ...
  obecnosci:        {},   // { 'YYYY-MM-DD_zmiana': [ { pracownikId, status, stanowisko } ] }
  nextId: {
    artykul: 10,
    osnowa:  31,
    pracownik: 11,
...
function getLoomType(id)     { return TYPY_KROSIEN.find(t => t.id === id) || null; }
